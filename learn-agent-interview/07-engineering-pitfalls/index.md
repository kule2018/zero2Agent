...
> 来源：字节 Agent 实习一面 【小红书数据库智能化二面追问：产品层面的等待体验优化】
...
**差距在哪**：新手只想到换模型。高手从流式输出、模型分级、服务架构、缓存和产品交互五个层面做了系统优化，且区分了 TTFT、TPS 与用户感知等待。面试官考的是你对大模型服务工程化的理解——延迟优化不只是“模型更快”，而是一个全栈工程问题。
